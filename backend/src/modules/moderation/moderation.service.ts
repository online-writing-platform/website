...
import { ModerationRepository } from "./moderation.repo.js";
import { type ModerationActionValue, type ModerationActor, type ModerationStore, type ReportTargetTypeValue } from "./moderation.types.js";
...
const store = new ModerationRepository();

export const moderationServices = { service: new ModerationService(store) };
