...
export const scheduleChapterPublicationSchema = schedulePublicationSchema.extend({
    expectedVersion: z.number().int().min(1),
}).strict();
...
export type ScheduleChapterPublicationBody = z.infer<typeof scheduleChapterPublicationSchema>;
