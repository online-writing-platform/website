...
export const reorderReadingListSchema = z.object({
    storyIds: z.array(uuidSchema).max(500),
...
export type ReorderReadingListInput = z.infer<typeof reorderReadingListSchema>;
