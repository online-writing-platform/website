import { DiscoveryRepository } from "./discovery.repo.js";
import { type DiscoveryCandidate, type DiscoverySignals, type DiscoveryStore } from "./discovery.types.js";
import { searchServices } from "./search/search.service.js";
...
const store = new DiscoveryRepository();

export const discoveryServices = {
    service: new DiscoveryService(store),
    search: searchServices.service,
};
