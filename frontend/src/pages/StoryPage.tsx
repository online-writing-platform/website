            ...
            <article className="story-detail">
                <aside className="story-cover-column">
                    ...
                    {status === "authenticated" ? (
                        ...
                        <Link
                            className="primary-action story-action-link"
                            to="/login"
                        >
                            افزودن به کتابخانه
                        </Link>
                ...
                <div className="story-detail-content">
                    ...
                    <div className="story-meta-row">
                        {story.genre ? (
                            <Link
                                to={`/browse/genres/${encodeURIComponent(
                                    story.genre.slug,
                                )}`}
                            >
                                {story.genre.name}
                    ...
                    {story.isMature ? (
                        <div className="status-message" data-kind="warning">
                            محتوای این داستان برای حساب‌های بزرگسال است. دسترسی
                            به متن فصل‌ها در سمت سرور با تاریخ تولد و تنظیمات
                            محتوای شما کنترل می‌شود.
                        </div>
                    ) : null}
                    ...
                    {story.tags.length > 0 ? (
                        <ul className="tag-list" aria-label="برچسب‌ها">
                            {story.tags.map((tag) => (
                                <li key={tag.slug}>
                                    <Link
                                        to={`/browse/tags/${encodeURIComponent(
                                            tag.slug,
                                        )}`}
                                    >
                                        #{tag.name}
