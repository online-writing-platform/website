...
export default function WriteDashboard() {
  ...
  const newStoryLanguage = getActiveStoryLanguage(i18n.resolvedLanguage);
  const newStoryTextAttributes = getStoryTextAttributes(newStoryLanguage);
      ...
      <section className="section-block">
        ...
        {stories.length === 0 ? (
          ...
          <div className="story-grid">
            {stories.map((story) => (
              <div key={story.id}>
                <StoryCard story={story} to={`/write/${story.id}`} />
