        ...
        while (dirtyRef.current && !conflictRef.current) {
            ...
            try {
                ...
                if (
                    ...
                    setStatusMessage(
                        "ذخیره متوقف شد: نسخه جدیدتری روی سرور وجود دارد.",
                    );
        ...
        <main className="editor-shell">
                    ...
                    <div className="button-row">
                        <button
                            ...
                            onClick={() => {
                                ...
                                setStatusMessage(
                                    "نسخه بازیابی محلی آماده ذخیره است.",
                                );
                            }}
                        >
                            بازیابی نسخه محلی
            ...
            {conflict && (
                ...
                >
                    ...
                    <p>
                        فصل بعد از نسخه {chapter.version} در جای دیگری تغییر
                        کرده است. برای جلوگیری از ازبین‌رفتن تغییرات جدید،
                        autosave متوقف شده است. پیش‌نویس محلی شما در مرورگر حفظ
                        می‌شود.
                    </p>
